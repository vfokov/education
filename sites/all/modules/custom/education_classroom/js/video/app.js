(function ($) {
  ...
  // function login() {
  // пароль и логин юзера https://voximplant.ru/ будут храниться в отдельных полях
  // передавать через drupal.settings
  // 2. Call возможно также нужно будет автоматически

  // 3. когда урок оплачен и создан classroom, берем данные ТИчера -создателя и Студента, которму назначен
  // урок, на основе данных их юзернейм (name) -
  // нужно создать пол-ля в https://voximplant.ru
  // https://voximplant.ru/docs/references/httpapi/managing_accounts#addaccount
...
if (!navigator.mediaDevices || !navigator.mediaDevices.enumerateDevices) {
  ...
  var username = Drupal.settings.vox_username;
  var password = Drupal.settings.vox_password;
