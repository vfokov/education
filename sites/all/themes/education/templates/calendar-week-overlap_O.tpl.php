        ...
        <tr>
          <?php for ($index = 0; $index < 8; $index++): ?>
            ...
            <?php elseif ($index == 7 ) : ?>
              <td class="last"">
            <?php else : ?>
              <td headers="<?php print $header_ids[$index]; ?>" data-week-day="<?php print $week_array[$week_days[$index-1]]; ?>">
            <?php endif; ?>
            ...
            <div class="half-hour full-hour" data-hour-full="<?php print $day_date; print ' '; print  $time_cnt + 1 . ':00' ; ?>" > &nbsp;</div>
            <div class="half-hour" data-hour-with-half="<?php print $day_date; print ' '; print $time_cnt + 1 . ':30' ?>" > &nbsp;</div>
