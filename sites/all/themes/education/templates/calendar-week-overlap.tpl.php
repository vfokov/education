          ...
          <?php for ($index = 0; $index < 8; $index++): ?>
            ...
            <?php if( $index == 0 ): ?>
              ...
              <div class="<?php print $class?>calendar-agenda-hour">
                <span class="calendar-hour"><?php print $time['hour'] == 'Before 01' ? '00' : $time['hour']; ?></span><span class="calendar-ampm"><?php print $time['ampm']; ?></span>
              </div>
            <?php else: ?>
            ...
            <div class="half-hour full-hour" data-hour-full="<?php print $day_date; print ' '; print  $time_cnt_output . ':00:00' ; ?>" >
              <?php //print $date_time; ?> &nbsp;
              <?php if (in_array($date_time, $teacher_dates)): ?>
                <a href="#" class="btn product__card-fast popup__link" data-popup="fast_cart" data-product-id="1" data-date="<?php print $date_time; ?>" data-teacher-uid="<?php print $uid; ?>">Book a lesson</a>
              <?php endif; ?>
            </div>

            <?php $with_half_date_time = $day_date . ' ' . $time_cnt_output . ':30:00'; ?>
            <div class="half-hour" data-hour-with-half="<?php print $day_date; print ' '; print $time_cnt_output . ':30:00' ?>" >
              <?php //print $with_half_date_time; ?> &nbsp;
              <?php if (in_array($with_half_date_time, $teacher_dates)): ?>
                <a href="#" class="btn product__card-fast popup__link" data-popup="fast_cart" data-product-id="1" data-date="<?php print $with_half_date_time; ?>" data-teacher-uid="<?php print $uid; ?>">Book a lesson</a>
              <?php endif; ?>
            </div>
