...
if (!empty($result['node'])) {
  ...
  foreach ($nodes as $lesson_node) {
    ...
    //echo '<pre>'; print_r($lesson_node); echo '</pre>'; die();
...
//echo '<pre>'; print_r($items); echo '</pre>'; die(); // 2020-04-29 16:30:00
//echo '<pre>'; print_r($teacher_dates); echo '</pre>'; die(); // 2020-04-29 16:30:00
